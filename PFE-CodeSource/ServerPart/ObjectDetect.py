...
net = cv2.dnn.readNetFromDarknet('/home/pi/LODBP/yolov4.cfg', '/home/pi/LODBP/yolov4.weights')
ln = net.getLayerNames()
ln = [ln[i - 1] for i in net.getUnconnectedOutLayers()]
DEFAULT_CONFIANCE = 0.5
THRESHOLD = 0.4
# load the COCO class labels our YOLO model was trained on
with open('/home/pi/LODBP/coco.names', 'r') as f:
...
while True:
    ...
    if len(indexes) > 0:
        ...
        for i in indexes.flatten():
            ...
            myobj.save("/home/pi/LODBP/text.mp3")
            os.system("mpg123 /home/pi/LODBP/text.mp3")
            print(mytext)
